"""Model for the mc_rounds table — per-round team-level aggregate percentages."""
...
class RoundControl:
    """Team-level map control aggregate percentages for one round.
    ...
    @staticmethod
    def from_dict(data: dict) -> "RoundControl":
        return RoundControl(
